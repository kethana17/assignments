...
@Repository
public class ProductDaoImp<T> implements IProductDAO {
	...
	public Product getProductById(int pid) {
		...
		Product product = (Product) jdbcTemplate.queryForMap(selectById, new ProductMapper(), pid);
	...
	public List<Product> getAllProducts() {
		...
		List<Product> list = (List<Product>) jdbcTemplate.query(selectAll, (ResultSetExtractor<T>) new ProductMapper());
